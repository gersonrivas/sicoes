...
<html>
    ...
    <body onload="startTimer(<%= (session.getMaxInactiveInterval() - 30) %>)">  
        ...
        <div id="page-wrap" style="border: 2px solid rgb(204, 204, 204);" align="center">
            ...
            <form name="nombre_form" id="id_form" method="post" action="seleccionProfesorAsignaturaSeccion.do">
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                <td align="center">
                                    Cédula: 
                                    <input type="text" name="cedula" value="${cedulaProfesorSession}" maxlength="9" onkeypress="return checkIt(event);">
                                    ${nombreProfesorSession}
                                </td>                               
