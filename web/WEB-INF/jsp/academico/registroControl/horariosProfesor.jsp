...
<html>
    ...
    <body onload="startTimer(<%= (session.getMaxInactiveInterval() - 30) %>)">  
        ...
        <div id="page-wrap" style="border: 2px solid rgb(204, 204, 204); " align="center" >
            ...
            <form name="nombre_form" id="id_form" method="post" action="horariosProfesor.do">
                ...
                <div class="datagrid">
                    ...
                    <table border="1">
                        <tr>
                            <th colspan="3" align="center">Horarios Profesor</th>
                        </tr>
                        <tr>                            
                            <!--a>Cédula</a>                                
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            ...
                            ${detalleHorariosProfesorSession}
