...
<html>
    ...
    <body onload="startTimer(<%= (session.getMaxInactiveInterval() - 30) %>)">  
        ...
        <div id="page-wrap" style="border: 2px solid rgb(204, 204, 204);" align="center">
            ...
            <form name="nombre_form" id="id_form" method="post" action="reportarPagosAdmon.do">
                ...
                <div class="datagrid">
                    ...
                    <table border="1">
                        <tr>
                            <th colspan="6" aling="center">
                                <h3 align="center">NOTIFICACIÓN DE PAGOS</h3>
                            </th>                            
                        </tr>
                        <tr>
                            <th align="center"><label for="lbcedula">Cédula / Pasaporte: ${cedulaUsuSession}</label></th>
                            <th align="center"><label for="lblperiodo">Período: ${periodosSession}</label></th>
                        </tr>
                        <tr>
                    ...
                    <table border="1">
                        <thead>
                            <tr>
                                <th>Fecha</th>
                                <th>Comprobante o Referencia</th>
                                <th>Monto</th>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="6" align="center" id="tdmsg">  
