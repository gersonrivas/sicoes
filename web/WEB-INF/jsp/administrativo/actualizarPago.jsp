...
<html>
    ...
    <body onload="startTimer(<%= (session.getMaxInactiveInterval() - 30) %>)">  
        ...
        <!--div id="page-wrap" th:replace="frag_inicial.jsp :: footer"-->
            ...
            <form name="nombre_form" id="id_form" method="post" action="actualizarPago.do">
                ...
                <div class="datagrid">
                    ...
                    <table border="1">
                        <thead>
                            <tr>
                                <th colspan="2">ACTUALIACIÓN DE PAGO</th>                                
                            </tr>
                        </thead>
                        <!-- Pagineo -->
                        ...
                        <tbody> 
                            ...
                            ${detalleActualiacionPagoSession}
