...
<html>
    ...
    <body onload="startTimer(<%= (session.getMaxInactiveInterval() - 30) %>)">                                 
        ...
        <div id="page-wrap" style="border: 2px solid rgb(204, 204, 204);" align="center">
            ...
            <form name="nombre_form" id="id_form" method="post" action="reporteInscripciones.do">
                ...
                <div class="datagrid">
                    ...
                    <table border="1">
                        <tr>
                            <th align="center"><label for="lbreporte">Reporte de Inscripciones</label></th>
                        </tr>
                    </table>
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                                <td align="center">
                                    ${sedeReporteInscritosSession}
                                </td>
                                <td align="center">
                                    ${periodoReporteInscritosSession}
                                </td>
                            </tr>
