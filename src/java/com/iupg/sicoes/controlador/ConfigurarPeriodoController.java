        ...
        if (misession.getAttribute("usuarioSession")==null) {
            ...
            if ("POST".equals(request.getMethod())) {                    
                ...
                if (request.getParameter("periodo") != null && !request.getParameter("periodo").equalsIgnoreCase("")  &&  !request.getParameter("periodo").equalsIgnoreCase("lbElige") && !request.getParameter("periodo").equalsIgnoreCase("lbSinPeriodo")) {
                        //&& (!daoGeneral.getPeriodo().equals(request.getParameter("periodo").substring(2, request.getParameter("periodo").length())))          )) {                        
                            
                    /*
                        if (daoGeneral.getPeriodo()==null||daoGeneral.getPeriodo()=="") {
                        ...
                        */
                        ...
                        //} 
                                ...
                                if (daoGeneral.getPeriodo()==null) {
                                        //|| !daoGeneral.getPeriodo().equalsIgnoreCase(request.getParameter("periodo"))) {
                                    ...
                                    if (daoGeneral.getPeriodo().equals(request.getParameter("periodo"))) {
                                        ...
                                        System.out.println(request.getParameter("id_grupo_horario"));
...
/*
  ...
  */          
                    ...
                    /*if (request.getParameter("estatus")==null) {
                        ...
                        daoGeneral.setEstatus(request.getParameter("estatus").substring(2, request.getParameter("estatus").length()));
                    }
                    
                    if (request.getParameter("periodo_divisas")==null) {
                        daoGeneral.setPeriodo_divisas("");
                    } else {
                        daoGeneral.setPeriodo_divisas(request.getParameter("periodo_divisas").substring(2, request.getParameter("periodo_divisas").length()));
                    }*/
                ...
                String accion = request.getParameter("action");
                    ...
                    switch (accion) {
                        ...
                        case "Adicionar": 
                            ...
                            //Mostrar los datos Academicos detalle en la tabla                
                            //String tablaDetalleAcademico = "";
                            //,daoGeneral.getEstatus());
		...
		//calendar.set(Calendar.MONTH, month);
                            ...
                            System.out.println(String.format("%04d",calendar.get(Calendar.YEAR)));
                            System.out.println(String.format("%02d",calendar.get(Calendar.MONTH)));
                            System.out.println(String.format("%02d",calendar.get(Calendar.DAY_OF_MONTH)));
                            
                            System.out.println(String.valueOf(Calendar.YEAR) + "-" + String.format("%02d",calendar.get(Calendar.MONTH)) + "-" + String.format("%02d",calendar.get(Calendar.DAY_OF_MONTH)));
            ...
            tablaDetalleAdministrativo =  tablaDetalleAdministrativo + "<tr><td align=\"right\">Valor de la Divisa:</td> <td align=\"left\"> <input type=\"number\" id=\"valor_divisa\" name=\"valor_divisa\" pattern=\"[0-9]+([\\.,][0-9]+)?\" min=\"0\" max=\"999999999999999\" step=\"0.01\" value=\"0\" align=\"center\"/></td> </tr>";
                        ...
                        case "Guardar":
                            ...
                            System.out.println(request.getParameter("periodo_divisas"));
                ...
                /*    
                    if (daoGeneral.getPeriodo()==null) {
                        ...
                        daoGeneral.setEstatus("");
                        daoGeneral.setPeriodo_divisas("");                        
                    } else if (!daoGeneral.getPeriodo().equals(request.getParameter("periodo"))) {
                        daoGeneral.setEstatus("");
                        daoGeneral.setPeriodo_divisas("");
                    }
                ...
                */  
                ...
                //System.out.println(request.getParameter("periodo").substring(2, request.getParameter("periodo").length()));
                //System.out.println(daoGeneral.getPeriodo());
            ...
            //misession.setAttribute("detallePeriodoAdministrativoSession", tablaDetalleAdministrativo);
                ...
                //Mostrar los datos Academicos detalle en la tabla                
                //String tablaDetalleAcademico = daoGeneral.BuscarDatosPeriodoAcademico(daoConexion.ConexionBD());
                        //,daoGeneral.getEstatus());
                //misession.setAttribute("detallePeriodoAcademicoSession", tablaDetalleAcademico);

                //Mostrar los datos Administrativos detalle en la tabla
                //String tablaDetalleAdministrativo = daoGeneral.BuscarDatosPeriodoAdministrativo(daoConexion.ConexionBD());
                //misession.setAttribute("detallePeriodoAdministrativoSession", tablaDetalleAdministrativo);

            
                //Para desplegar el boton de adicionar o eliminar
                /*if (daoGeneral.getPeriodo()!=null ) {
                    if (!tablaDetalleAcademico.isEmpty() && !tablaDetalleAdministrativo.isEmpty() && !daoGeneral.getPeriodo().equals("Elige") && !daoGeneral.getPeriodo().equals("SinPeriodo")) {
                        misession.setAttribute("botonSession","<input name=\"action\" type=\"submit\" id=\"adicionar\" value=\"Adicionar\" /> <input name=\"action\" type=\"submit\" id=\"editar\" value=\"Editar\" /> <input name=\"action\" type=\"submit\" id=\"eliminar\" value=\"Eliminar\" />");
                    } else {
                        if (tablaDetalleAcademico.isEmpty() || tablaDetalleAdministrativo.isEmpty()) {
                            misession.setAttribute("botonSession", "<input name=\"action\" type=\"submit\" id=\"adicionar\" value=\"Adicionar\" />");
                        } else {
                            misession.setAttribute("botonSession", "<input name=\"action\" type=\"submit\" id=\"adicionar\" value=\"Adicionar\" />");
                        }
