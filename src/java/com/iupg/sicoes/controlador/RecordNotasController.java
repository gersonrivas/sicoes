 ...
 * @author Gerson Rivas
 */
public class RecordNotasController extends AbstractController {
    private DaoConexion daoConexion;
    
    public RecordNotasController() {
    }
    ...
    protected ModelAndView handleRequestInternal(
        ...
        //Inicilizo variable de sesion para el manejo del filtro de Especialidades del Alumno.
        String opcionesEspecialidades = daoAlumno.BuscarEspecialidadesAlumno(daoConexion.ConexionBD());
        misession.setAttribute("especialidadesAlumnoSession", opcionesEspecialidades);        
